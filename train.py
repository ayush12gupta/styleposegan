...
def setup_training_loop_kwargs(
    ...
    args.G_kwargs = dnnlib.EasyDict(class_name='training.networks.Generator', z_dim=2048, w_dim=512, mapping_kwargs=dnnlib.EasyDict(), synthesis_kwargs=dnnlib.EasyDict())
