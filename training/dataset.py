...
# in getitem I have to return target pose, source pose, target apperance, source apperance, target image, source image
...
class ImageFolderDataset(Dataset):
    def __init__(self,
        ...
        **super_kwargs,         # Additional arguments for the Dataset base class.
        ...
        if os.path.isdir(self._path):
            ...
            self.pairs = [(source[i], target[i]) for i in range(len(source))]
        ...
        PIL.Image.init()
        self._image_fnames = sorted(fn for fn in glob.glob(self._path + '/*/*/*/*.jpg'))
    ...
    def _load_raw_image(self, raw_idx):
        source, target = self.pairs[raw_idx]
        ...
        return image_s, image_t, ap_s, ap_t, pose_s, pose_t
